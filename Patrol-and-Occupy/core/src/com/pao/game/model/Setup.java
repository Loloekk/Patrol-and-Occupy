...
import com.pao.game.model.GameObject.Obstacles.BreakableObstacle.BreakableObstacleFactory;
import com.pao.game.model.GameObject.Obstacles.UnbreakableObstacle.UnbreakableObstacleFactory;
...
public class Setup {
    ...
    static{
        ...
        // Setup 1.
        {
            ...
            objectList.addAll(Obstacle.rectangleObstacle(1000, 200, 50, 1, 5, 0,new UnbreakableObstacleFactory()));
            objectList.addAll(Obstacle.rectangleObstacle(1300, 800, 50, 5, 1, 0,new UnbreakableObstacleFactory()));
            objectList.addAll(Obstacle.rectangleObstacle(900, 600, 50, 2, 1, 0,new UnbreakableObstacleFactory()));

            objectList.addAll(BreakableObstacle.rectangleObstacle(400, 700, 50, 2, 6, 30,new BreakableObstacleFactory()));
            objectList.addAll(BreakableObstacle.rectangleObstacle(400, 400, 50, 4, 1, 0,new BreakableObstacleFactory()));
        ...
        // Setup 2.
        {
            ...
            objectList.addAll(Obstacle.rectangleObstacle(500, 500, 80, 1, 5, 0,new UnbreakableObstacleFactory()));
            objectList.addAll(Obstacle.rectangleObstacle(1000, 200, 80, 5, 1, 0,new UnbreakableObstacleFactory()));
            objectList.addAll(Obstacle.rectangleObstacle(1300, 800, 80, 1, 3, 0,new UnbreakableObstacleFactory()));
            objectList.addAll(Obstacle.rectangleObstacle(200, 600, 80, 1, 5, 0,new UnbreakableObstacleFactory()));
