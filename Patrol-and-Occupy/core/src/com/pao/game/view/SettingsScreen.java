...
public class SettingsScreen implements Screen {
    ...
    public SettingsScreen(Drop game) {
        ...
        tankSpeedSlider = makeSlider(ModelConstants.getConstant("min.TankSpeed"), ModelConstants.getConstant("max.TankSpeed"), ModelConstants.getConstant("step.TankSpeed"), false, Drop.WIDTH/2 - sliderWidth*3/2, 850f, tankSpeed);
        tankSpeedSlider.setValue(EditSettings.getTankSpeed());
        stage.addActor(tankSpeedSlider);
        rotateSpeedSlider = makeSlider(ModelConstants.getConstant("min.RotateSpeed"), ModelConstants.getConstant("max.RotateSpeed"), ModelConstants.getConstant("step.RotateSpeed"), false, Drop.WIDTH/2 + sliderWidth/2, 850f, rotateSpeed);
        rotateSpeedSlider.setValue(EditSettings.getRotateSpeed());
        stage.addActor(rotateSpeedSlider);
        bulletSpeedSlider = makeSlider(ModelConstants.getConstant("min.BulletSpeed"), ModelConstants.getConstant("max.BulletSpeed"), ModelConstants.getConstant("step.BulletSpeed"), false, Drop.WIDTH/2 - sliderWidth*3/2, 700f, bulletSpeed);
        bulletSpeedSlider.setValue(EditSettings.getBulletSpeed());
        stage.addActor(bulletSpeedSlider);
        magazineCapacitySlider = makeSlider(ModelConstants.getConstant("min.MagazineCapacity"), ModelConstants.getConstant("max.MagazineCapacity"), ModelConstants.getConstant("step.MagazineCapacity"), false, Drop.WIDTH/2 + sliderWidth/2, 700f, magazineCapacity);
        magazineCapacitySlider.setValue(EditSettings.getMagazineCapacity());
        stage.addActor(magazineCapacitySlider);
        shootCooldownSlider = makeSlider(ModelConstants.getConstant("min.ShootCooldown"), ModelConstants.getConstant("max.ShootCooldown"), ModelConstants.getConstant("step.ShootCooldown"), false, Drop.WIDTH/2 - sliderWidth*3/2, 550f, shootCooldown);
        shootCooldownSlider.setValue(EditSettings.getShootCooldown());
        stage.addActor(shootCooldownSlider);
        receiveCooldownSlider = makeSlider(ModelConstants.getConstant("min.ReceiveCooldown"), ModelConstants.getConstant("max.ReceiveCooldown"), ModelConstants.getConstant("step.ReceiveCooldown"), false, Drop.WIDTH/2 + sliderWidth/2, 550f, receiveCooldown);
        receiveCooldownSlider.setValue(EditSettings.getReceiveCooldown());
        stage.addActor(receiveCooldownSlider);
        gameTimeSlider = makeSlider(ModelConstants.getConstant("min.GameTime"), ModelConstants.getConstant("max.GameTime"), ModelConstants.getConstant("step.GameTime"), false, Drop.WIDTH/2 - sliderWidth*3/2, 400f, gameTime);
        gameTimeSlider.setValue(EditSettings.getGameTime());
        stage.addActor(gameTimeSlider);
        respawnSlider = makeSlider(ModelConstants.getConstant("min.RespawnCooldown"), ModelConstants.getConstant("max.RespawnCooldown"), ModelConstants.getConstant("step.RespawnCooldown"), false, Drop.WIDTH/2 + sliderWidth/2, 400f, respawnCooldown);
        respawnSlider.setValue(EditSettings.getRespawnCooldown());
        stage.addActor(respawnSlider);
        dynamiteCoolDownSlider = makeSlider(ModelConstants.getConstant("min.DynamiteCooldown"), ModelConstants.getConstant("max.DynamiteCooldown"), ModelConstants.getConstant("step.DynamiteCooldown"), false, Drop.WIDTH/2 - sliderWidth/2 , 250f, dynamiteCooldown);
